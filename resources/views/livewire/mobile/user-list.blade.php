<div>
    <main class=" max-w-7xl mx-auto   mt-8">
        <section class=" md:w-[1180px] m-2  h-auto flex flex-col bg-[#F5F5F580] rounded-2xl shadow-xl  p-2  items-center" style="box-shadow: 0px 4px 4px 0px #00000040, 0 0 0 0 #3B82F6;"
            style="font-family: IRYekan;">
            <!--header-->
            <div class="flex flex-col md:flex-row justify-between w-full   h-[40px] mt-1">
                ...
                <div class="flex flex-row gap-1 ">
                    ...
                    <div class="relative  w-[60px]  md:w-[150px]  ">
                        <input type="text" class="w-full h-full rounded-md md:rounded-xl bg-[#0948EE14] absolute top-0
                            md:pb-2    pr-2 text-[8px] md:text-[16px]" placeholder="جستجو">
                        <!--mobile mode-->
                    ...
                    <div
                        ...
                        <span class="text-[7px] md:text-sm">
                            چاپ کردن
                        </span>
                    </div>
                    <!--add-->
            ...
            <!--container -->
            <!--pc mode-->
            <div class="flex flex-col justify-center w-full h-auto gap-1 mt-2 border border-[#0948EE] rounded-xl" >
                <!--title-->
                        <div class="hidden md:flex text-center  text-lg " style="font-style: Regular;">
                            <table class="w-full text-center border-separate border-spacing-0">
                                <tr>
                                    ...
                                    <th class="p-4  bg-[#0948EE26]">اسم کاربری</th>
                                    <th class="p-4  bg-[#0948EE26]">شماره</th>
                                    <th class="p-4  bg-[#0948EE26]">ایمیل</th>
                                    <th class="p-4  bg-[#0948EE26]">آدرس</th>
                                    <th class="p-4  bg-[#0948EE26]">نقش</th>
                                    <th class="p-4  bg-[#0948EE26]">وضعیت</th>
                                    <th class="p-4  bg-[#0948EE26]">پسورد</th>
            ...
            <div class="flex flex-row justify-between w-full my-3 text-[10px]">
                ...
                <div class="flex flex-row gap-2">
                    ...
                    <span class="border px-2 py-0.5 border-[#1E00FF] rounded-md text-center">
                        10
                    </span>
                </div>
            </div>
            <!--mobile mode-->
            <div class="container flex flex-col gap-2 md:hidden text-[10px] w-full" style="font-family: IRYekan;">
                <div class="rounded-2xl flex flex-col items-center mt-2 border border-[#0948EE66] h-auto w-full">
                    <table dir="ltr"
                        ...
                        <tr>
                            <th colspan="3" class="text-center text-[14px]">
                                احمد عزیزی
                            </th>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-[#00000080] pb-2">
                                ahmad32
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr class="text-[#00000080]">
                            <td>0793982928</td>
                            <td>ahmad32@gmail.com</td>
                            <td>باغچه گلها</td>
                        </tr>
                        <tr>
                            <th class="pt-3">نقش</th>
                            <th class="pt-3">وضعیت</th>
                            <th class="pt-3">پسورد</th>
                        </tr>
                        <tr class="text-[#00000080]">
                            <td>مدیر</td>
                            <td>فعال</td>
