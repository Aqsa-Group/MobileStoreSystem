...
<div class=" text-gray-800 overflow-hidden">
  ...
  <div class="min-h-full flex items-center justify-center p-3 sm:p-4">
    ...
    <div class="animate-fade-slide  shadow-xl shadow-[0px_4px_4px_0px_#00000040] w-full md:w-[600px] lg:w-[1100px] bg-[#fafafa] rounded-2xl overflow-hidden flex flex-col lg:flex-row opacity-0 transform translate-y-10">
