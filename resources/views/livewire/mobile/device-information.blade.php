...
<div class="  text-gray-800 flex items-center justify-center p-3 sm:p-4">
  ...
  <!-- باکس اصلی سفید -->
  <div class="w-full md:w-[600px] mt-[50] shadow-xl shadow-[0px_4px_4px_0px_#00000040] bg-[#fafafa] lg:w-[1100px] bg-white rounded-2xl shadow-lg flex flex-col lg:flex-row overflow-hidden">
